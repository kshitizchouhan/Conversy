      ...
      <div className="relative w-full max-w-6xl grid lg:grid-cols-2 gap-10">
        ...
        <div className="bg-white rounded-[2.5rem] p-8 sm:p-10 shadow-xl border border-black/5">
          ...
          <p className="text-gray-500 mt-2 mb-6">
            Meet people. Chat freely. Break language barriers.
          </p>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <input
              ...
              className="w-full px-4 py-3 rounded-2xl bg-gray-50 border
               text-gray-600
               border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-400"
            ...
            <button
              type="submit"
              className="w-full py-3 rounded-2xl bg-emerald-500 text-white font-bold text-lg hover:bg-emerald-600 active:scale-95 transition"
            >
              {isPending ? "Setting things up…" : "Start chatting 🚀"}
            </button>
          </form>
